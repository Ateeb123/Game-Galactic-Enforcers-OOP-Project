...
Hero::Hero(SDL_Window* gWindow,SDL_Renderer* grenderer,List<GameObjects*>* lst):health(100,gWindow,grenderer,1,490)
{
    this->bullets =lst;
    ...
    dRect = dRect;
    ground = (this->get_Position()).get_Y()+(this->get_Size()).get_Y();
}
bool Hero::IsMoved()
{
    return moved;
