 ...
 Menu::Menu(SDL_Event* e,SDL_Window* gWindow,SDL_Renderer* gRenderer,string Path,int width, int height)
{
    ...
    this->Buttons[0]= new Button(gRenderer,gWindow,"Data\\Buttons\\MainMenu\\start0.png",{1015,250},{422,100});
    this->Buttons[1]= new Button(gRenderer,gWindow,"Data\\Buttons\\MainMenu\\load0.png",{1015,360},{422,100});
    this->Buttons[2]= new Button(gRenderer,gWindow,"Data\\Buttons\\MainMenu\\quit0.png",{1015,470},{422,100});
    this->e = e;
    Enable = false;
}
bool Menu:: IsEnable()
