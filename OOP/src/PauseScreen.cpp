...
PauseScreen::PauseScreen(SDL_Event* e,SDL_Window* gWindow,SDL_Renderer* gRenderer,string Path,int width, int height)
{
    ...
    this->Buttons[0]= new Button(gRenderer,gWindow,"Data\\Buttons\\Pause\\resume0.png",{1015,350},{422,100});
    this->Buttons[1]= new Button(gRenderer,gWindow,"Data\\Buttons\\Pause\\quit0.png",{1015,460},{422,100});
    this->e = e;
    Enable = false;
}
