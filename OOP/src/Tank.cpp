...
Tank::Tank(SDL_Window* gWindow,SDL_Renderer* gRenderer,int posX,int posY,List<GameObjects*>* bullets):health(150,gWindow,gRenderer,posX,posY-20)
{
    Alive = true;
...
void Tank::fire()
{
    bullets->add(new Bullet(gWindow,gRenderer,dRect->x,dRect->y+40,-10,0,"ENEMYBULLET"));
}
